    ...
    public partial class PostCreateHandler : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            try
            {
                ...
                if (targetEntity.LogicalName != "pub_drink") return;
                ...
                updatedContact.Attributes.Add("description", "Dave's extending CRM sessions are the best");
